...
**Verified to work with the 2024 published version of the data (exporting data from 2009 - 2023 to the eBMS format). Note that there seems to be a discrepancy with the earlier data version in GBIF, where we now have fewer occurrence records exported to GBIF. I've checked and the number of lepidoptera records match the earlier data version. The bumblebee records doesn't display any obvious errors either. The source of the discrepancy remains to be found. It could have something to do with changes in how we report zero occurrences. In any case, the lepidoptera data should conform to the earlier exports.**
